    ...
    ! function() {
        ...
        var e = function(t) {
            ...
            s = function o() {
                ...
                var l = p[0] || {},
                    ...
                    f = p.length,
                    v = !1;
                for ("boolean" == typeof l && (v = l, l = p[y] || {}, y += 1), "object" !== n(l) && i(l) && (l = {}), y === f && (l = t, y -= 1); y < f; y++)
                    if (a = p[y], !e(a) && null !== a)
        ...
        var ft = /iphone|ipod|android|ie|blackberry|fennec/.test(null === (at = window.navigator) || void 0 === at || null === (rt = at.userAgent) || void 0 === rt ? void 0 : rt.toLowerCase()),
            vt = {
                ...
                show: function(t) {
                    var n = this;
                    this._initDate = null, this._initTime = null, this._value = null, this.input = t, this._draw(),
                        function(t, n) {

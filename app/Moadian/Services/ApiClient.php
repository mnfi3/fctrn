...
namespace App\Moadian\Services;

use GuzzleHttp\Client;
use App\Moadian\Exceptions\MoadianException;
use App\Moadian\Http\{EconomicCodeInformation, Packet, ServerInfoPacket, GetTokenPacket, FiscalInfoPacket, InquiryByReferenceNumber, InquiryByUid, invoicePacket, Request, Response};
...
class ApiClient
{
    ...
    public function __construct($username, $privateKey, $baseUri = 'https://sandboxrc.tax.gov.ir/')
    {
        $baseUri = env('MOADIAN_URL', 'https://sandboxrc.tax.gov.ir/');

...
@section('content')
    ...
    <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
        ...
        <div class="w-lg-600px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
            <!--begin::Form-->
            <form class="form w-100 mb-10" method="post" action="{{route('register.verify-mobile')}}" novalidate="novalidate" id="kt_sing_in_two_steps_form">
                <div class=" flex-column align-items-between my-1 p-0">
                    ...
                    @endif
                        @if(strlen($fail) > 1)
                            <h6 class=" m-auto alert alert-danger"> {{$fail}}</h6>
                        @endif
                ...
                <div class="text-center mb-10">
                    <img alt="Logo" class="mh-125px" src="{{asset('dash-assets/media/logos/CompLogo.png')}}" />
                </div>
                <!--end::Icon-->
                <!--begin::Heading-->
                <div class="text-center mb-10">
                ...
                <div class="mb-10 px-md-10">
                    ...
                    <!--end::Label-->
                    <!--begin::Input group-->
                    <input type="text" name="code" class="form-control form-control-solid text-center border-primary border-hover mx-1 my-2" id="user-name " placeholder="کد تایید را وارد نمایید." style="height: 45px" required>

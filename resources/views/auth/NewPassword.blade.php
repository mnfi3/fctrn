...
@section('title', 'ثبت رمز عبور جدید')
@section('content')
    <!--begin::Content-->
        ...
        <div class="w-lg-550px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
            ...
            <form class="form w-100" novalidate="novalidate" id="kt_new_password_form">
                ...
                <div class="text-center mb-10">
                    <!--begin::Title-->
                    <h1 class="text-dark mb-3">ثبت رمز عبور جدید</h1>
                    <!--end::Title-->
                    <!--begin::Link-->
                    <div class="text-gray-400 fw-bold fs-4">رمز عبور خود را بازیابی کرده اید؟
                    <a href="/" class="link-primary fw-bolder">وارد شوید</a></div>
                    <!--end::Link-->
                </div>
                <!--begin::Heading-->
                <!--begin::Input group-->
                <div class="mb-10 fv-row" data-kt-password-meter="true">
                    ...
                    <!--end::Wrapper-->
                    <!--begin::Hint-->
                    <div class="text-muted">رمز عبور انتخابی باید بیش از ۸ کاراکتر بوده و شامل نمادها و کاراکترهای خاص باشد.</div>
                    <!--end::Hint-->
                </div>
                <!--end::Input group=-->
                <!--begin::Input group=-->
                <div class="fv-row mb-10">
                    <label class="form-label fw-bolder text-dark fs-6">تاییید رمز عبور</label>

...
@section('title', 'بسته های نامحدود')
        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">لیست بسته های نا محدود
                        <!--begin::Separator-->
                        <span class="h-20px border-gray-200 border-start ms-3 mx-2"></span>
                        <!--end::Separator-->
                        <!--begin::Description-->
                        <small class="text-muted fs-7 fw-bold my-1 ms-1">تمام بسته های نامحدود ثبت شده را در این بخش مشاهده نمایید.</small>
                        <!--end::Description--></h1>
                    <!--end::Title-->
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-body py-3">
                            <form action="{{route('package.insert')}}" method="post" class="form" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="type" value="infinite">
                                <fieldset class="px-0">
                                            ...
                                            <div class="card-body">
                                                <div class="row mb-4">
                                                    <div class="col-md-2 fv-row">
                                                        ...
                                                        <input type="text" class="form-control form-control-solid required" required name="name" placeholder="بسته سه ماهه" >
                                                    </div>
                                                    <div class="col-md-2 fv-row">
                                                    ...
                                                    <div class="col-md-2 fv-row">
                                                        <label class="required fs-6 fw-bold mb-2 fw-bolder">تعداد روز فعال بودن بسته:</label>
                                                        <input type="number" class="form-control form-control-solid required" required name="day_count" placeholder="90" >
                                                    </div>
                                    ...
                                    <tr class="fw-bolder text-muted text-center">
                                            ...
                                            @foreach($packages as $package)
                                                <tr class="text-center">
                                                    ...
                                                    <td>{{$package->day_count}}</td>
                                                    <td>{{$package->desc}}</td>
                                                    <td>
                                                        <a href="{{route('package.delete', ['infinte', $package->id])}}" class="stop-link badge badge-danger"> حذف </a>
                                                    </td>
                                                </tr>
                                            @endforeach

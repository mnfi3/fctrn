                    ...
                    <div class="card mb-5 mb-xl-10">
                        ...
                        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_signin_method">
                            <div class="card-title m-0">
                                <h3 class="fw-bolder m-0">عدم دسترسی</h3>
                            </div>
                        </div>
                        <!--end::Card header-->
                        <!--begin::Content-->
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <div class="fs-3 fw-bold mx-8">
                                                شما به این صفحه دسترسی ندارید.لطفا از این صفحه تصویر تهیه کرده و از طریف بخش «تیکت» برای بررسی و رفع سریع مشکل توسط همکاران ما، ارسال نمایید.
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 mt-4">
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <a class="btn btn-primary mx-4" href="{{route('dashboard')}}">رفتن به پیشخوان</a>
                                            </div>

...
@section('title', 'ثبت شناسه کالا و خدمت')
@section('content')
    <!--begin::Content-->
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">ثبت شناسه کالا/خدمت
                        <!--begin::Separator-->
                        <span class="h-20px border-gray-200 border-start ms-3 mx-2"></span>
                        <!--end::Separator-->
                        <!--begin::Description-->
                        <small class="text-muted fs-7 fw-bold my-1 ms-1">برای ثبت شناسه کالا/خدمت جدید از طریق فرم زیر اقدام نمایید.</small>
                        <!--end::Description--></h1>
                    <!--end::Title-->
                </div>
                <!--end::Page title-->
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <!--begin::Basic info-->
                    <!--begin::Form-->
                    <form method="POST" action="{{route('product.insert')}}" id="kt_account_profile_details_form" class="form" enctype="multipart/form-data">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
                                ...
                                <div class="card-title m-0">
                                    <h3 class="fw-bolder m-0">اطلاعات شناسه کالا</h3>
                                </div>
                                <!--end::Card title-->
                            </div>
                            <!--begin::Card header-->
                                ...
                                <div class="card-body border-top p-9">
                                    ...
                                    <div class="row g-9 mb-8">
                                        ...
                                        <div class="col-md-2 fv-row">
                                            <input type="checkbox" name="specialOrGeneral" value="1">
                                            <label class="fw-bolder required fs-6 fw-bold mb-2">اختصاصی</label>
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-3 fv-row">
                                            <label class="fw-bolder required fs-6 fw-bold mb-2">شناسه کالا/خدمت</label>
                                            <input type="text" class="form-control form-control-solid" placeholder="15045504744" name="taxTpStoPartCode" required>
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-2 fv-row">
                                            <label class="fw-bolder required fs-6 fw-bold mb-2">نرخ ارزش افزوده</label>
                                            <input type="text" class="form-control form-control-solid" placeholder="9" value="10" name="vat" required>
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-5 fv-row">
                                            <label class="fw-bolder required fs-6 fw-bold mb-2">شرح شناسه</label>
                                            <input type="text" class="form-control form-control-solid required" placeholder="شرح کالا/خدمت" name="descriptionOfId"  required>
                                        </div>
                                    </div>
                                    <!--end::Input group-->
                                </div>
                    ...
                    <div class="card mb-5 mb-xl-8">
                        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
                            <!--begin::Card title-->
                            <div class="card-title m-0">
                                <h3 class="fw-bolder m-0">لیست شناسه های من</h3>
                            </div>
                            <!--end::Card title-->
                        </div>
                        <!--begin::Body-->

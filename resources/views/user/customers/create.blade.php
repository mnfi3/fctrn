    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">ثبت مشتری
                        <!--begin::Separator-->
                        <span class="h-20px border-gray-200 border-start ms-3 mx-2"></span>
                        <!--end::Separator-->
                        <!--begin::Description-->
                        <small class="text-muted fs-7 fw-bold my-1 ms-1">برای ثبت مشتری جدید از طریق فرم زیر اقدام نمایید.</small>
                        <!--end::Description--></h1>
                    <!--end::Title-->
                </div>
                <!--end::Page title-->
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <!--begin::Basic info-->
                    <!--begin::Form-->
                    <form method="POST" action="{{route('customer.insert')}}" id="kt_account_profile_details_form" class="form" enctype="multipart/form-data">
...
{{--                                        </div>--}}
                                        ...
                                        <div class="col-md-4 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder="کد اقتصادی شرکت یا فرد خریدار را وارد نمایید..." name="economic_code" required>
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-4 fv-row">
                                            <label class="fw-bolder required fs-6 fw-bold mb-2">شماره/شناسه ملی/مدنی/اتباع</label>
                                            <input type="text" class="form-control form-control-solid" placeholder="شماره/شناسه ملی/مدنی/اتباع را وارد نمایید..." name="national_code" required>
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        ...
                                        <div class="col-md-3 fv-row">
                                            ...
                                            <select class="form-select form-select-solid" data-control="select2" data-placeholder="نوع شخصیت خریدار را مشخص کنید..." name="type" required>
                                                <option value="{{Customer::TYPE_LEGAL}}">حقوقی</option>
                                                <option value="{{Customer::TYPE_INDIVIDUAL}}">حقیقی</option>
                                                <option value="{{Customer::TYPE_PARTICIPATION}}">مشارکت مدنی</option>
                                                <option value="{{Customer::TYPE_FOREIGN}}">اتباع غیر ایرانی</option>
                                                <option value="{{Customer::TYPE_CONSUMER}}">مصرف کننده نهایی</option>
                                            </select>
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        ...
                                        <div class="col-md-3 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder="کد پستی را وارد نمایید..." name="postal_code" required>
                                        </div>
                                        <div class="col-md-3 fv-row">
                                            <label class="fw-bolder  fs-6 fw-bold mb-2">شماره ثبت</label>
                                            <input type="text" class="form-control form-control-solid" placeholder="شماره ثبت شرکت را وارد نمایید..." name="insert_number" >
                                        </div>

                                        <div class="col-md-3 fv-row">
                                            <label class="fw-bolder fs-6 fw-bold mb-2">پست الکترونیک</label>
                                            <input type="email" class="form-control form-control-solid" placeholder="آدرس ایمیل را وارد نمایید..." name="email">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-3 fv-row">
                                            <label class="fw-bolder fs-6 fw-bold mb-2">فکس</label>
                                            <input type="text" class="form-control form-control-solid" placeholder="فکس را وارد نمایید..." name="fax">
                                        </div>
                                        ...
                                        <div class="col-md-3 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder="نام شهر خود را وارد نمایید..." name="city">
                                        </div>
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <textarea class="form-control form-control-solid" placeholder="آدرس را وارد نمایید..." name="address" rows="3"></textarea>
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    <!--end::Input group-->

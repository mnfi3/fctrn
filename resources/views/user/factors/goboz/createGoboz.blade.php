...
@section('title', 'ثبت فاکتور قبوض خدماتی')
@section('content')
                                        ...
                                        <div class="card-body border-top p-9">
                                            ...
                                            <div class="row g-9">
                                                <div class="col-md-12 fv-row">
                                                    <label class="fw-bolder required fs-6 fw-bold mb-2">مؤدی(فروشنده) را انتخاب کنید</label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div id="kt_account_moshtari_details">
                                        ...
                                        <div class="card-body border-top p-9">
                                            ...
                                            <div class="row g-9">
                                                <div class="col-md-12 fv-row">
                                                    <label class="fw-bolder fs-6 fw-bold mb-2">مشتری را انتخاب کنید</label>
                                ...
                                <div class="card-body border-top p-9">
                                    ...
                                    <div class="row g-9">
                                        ...
                                        <div class="col-md-3 fv-row d-none">
                                            ...
                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider" value="1" name="inty" id="inty">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-2 fv-row d-none">
                                            <label class="required fs-6 fw-bold mb-2 fw-bolder">الگو</label>
                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider" value="5" name="inp" id="inp">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        ...
                                        <!--begin::Col-->
                                        <div class="col-md-3 fv-row">
                                            <label class=" fs-6 fw-bold mb-2 fw-bolder required">شماره اشتراک/شناسه قبض بهره بردار</label>
                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300"  placeholder="شماره اشتراک/شناسه قبض بهره بردار را وارد نمایید." name="billid" >
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-3 fv-row">
                                    ...
                                    $(document).ready(function(){
                                        ...
                                        $(".add").click(function(){
                                            ...
                                            $("#div_" + nextindexx).append('<td><a class="remove" id="remove_' + nextindexx + '" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="حذف"><i class="bi bi-trash-fill text-danger fs-4"></i></a></td>' +
                                                ...
                                                '<td class="d-none"><input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider" name="D21['+nextindexx+']" id="D21['+nextindexx+']"/></td>' +
            ...
            var product = document.getElementById('inp').value;
                ...
                document.querySelectorAll('#contain tbody tr').forEach(row => {
                    ...
                    if (UnitAmountInput && TedadInput) {
                        ...
                        var VatAmountValue = Math.floor(((rowTotal - Discount) * (parseFloat(VatRate.value.replace(/,/g, ''))/100)));
                        if (rowTotalInput) {
                            rowTotalInput.value = rowTotal - Discount + VatAmountValue + parseFloat(odam.value.replace(/,/g, '')) + parseFloat(olam.value.replace(/,/g, ''));
                        }
                    }
                    divider('D7[' + i + ']');
                    divider('D6[' + i + ']');
    ...
    <script>
        ...
        function SetVatRate() {
            var product = document.getElementById('inp').value;
                ...
                var vatRateInputG = document.getElementById('VatRate');
        ...
        function CalculatePercantage() {
            ...
            //
            odam = document.getElementById("odam").value = Math.floor(((+AmountBeforeDiscount - +Discount)*(+odr/100)));
            olam = document.getElementById("olam").value = Math.floor(((+AmountBeforeDiscount - +Discount)*(+olr/100)));

            document.getElementById("AmountAfterDisCount").value = (+UnitAmount * +Tedad) - +Discount;

            var VatAmount = document.getElementById("VatAmountG").value =  Math.floor((((+UnitAmount * +Tedad)- +Discount)*(VatRate/100)));
            document.getElementById("billG").value = (+UnitAmount * +Tedad) - +Discount + +VatAmount + +odam + +olam;
        ...
        function CalculateFactor() {
            ...
            if (odam) {
                resultOdr = (+odam / (+AmountBeforeDiscount - +Discount)) * 100;
                document.getElementById("odr").value = resultOdr.toFixed(4);
            }
            if (olam) {
                resultOlr = (+olam / (+AmountBeforeDiscount - +Discount)) * 100;

                                ...
                                <div class="card-body border-top p-9">
                                    ...
                                    <div class="row g-9 mb-8">
                                        ...
                                        <div class="col-md-2 fv-row">
                                            ...
                                            @endphp
                                            <input type="text" class="form-control form-control-solid  border-1 border border-gray-300" placeholder="1401/01/01" value="{{toPersianDate(date('Y-m-d', $invoice->indatim/1000))}}" data-jdp data-jdp-min-date="{{toPersianDate($date)}}" data-jdp-max-date="today" name="indatim" required>
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                ...
                                <div class="card-body border-top p-9">
                                    ...
                                    <div class="row g-9">
                                        ...
                                        <div class="col-md-4 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid  border-1 border border-gray-300  number-divider" placeholder="مبلغ بعد از تخفیف" name="AmountAfterDiscount" id="AmountAfterDiscount" readonly>
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-4 fv-row">
                                ...
                                <script>
                                    $(document).ready(function(){
                                        ...
                                        $(".addd").click(function(){
                                            ...
                                            document.getElementById('select2-sstid-container').innerText = 'نوع کالا/خدمت';
                                            document.getElementById('Unit').value = null;
                                            document.getElementById('select2-Unit-container').innerText = 'واحد اندازه گیری';
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3" id="containn">
                                            ...
                                            <tr class="fw-bolder text-center">
                                                ...
                                                <th class="min-w-100px">تخفیف(ریال)</th>
                                            ...
                                            @foreach($invoice->items as $item)
                                                <tr class='text-center elementz' id='divz_{{$i+1}}'>
                                                    ...
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D13[{{$i+1}}]" id="D13[{{$i+1}}]" value="{{$item->bsrn}}" readonly/></td>
                                                    <td><a class="remove" id="remove_{{$i+1}}"><i class="bi bi-trash-fill text-danger fs-4"></i></a></td>
                                                </tr>
                                                @php
                                                    $i = $i+1;
                                ...
                                <div class="card-body border-top p-9">
                                    ...
                                    <div class="row g-9 mb-8">
                                        ...
                                        <div class="col-md-4 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " placeholder="0" name="tprdis" value="{{number_format($invoice->tprdis)}}" required readonly id="tprdis">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-4 fv-row">
                                            <label class="fw-bolder fs-6 fw-bold mb-2 required">مجموع تخفیفات</label>
                                            <input type="text" class="form-control form-control-solid  border-1 border border-gray-300 "  placeholder="0" name="tdis" value="{{number_format($invoice->tdis)}}" required readonly id="tdis">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-4 fv-row">
                                            <label class="fw-bolder fs-6 fw-bold mb-2 required">مجموع مبلغ پس از کسر تخفیف</label>
                                            <input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " placeholder="0" name="tadis" value="{{number_format($invoice->tadis)}}" required readonly id="tadis">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-4 fv-row">
                                            <label class="fw-bolder fs-6 fw-bold mb-2 required">مجموع مالیات بر ارزش افزوده</label>
                                            <input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " placeholder="0" name="tvam" value="{{number_format($invoice->tvam)}}" required readonly id="tvam">
                                        </div>
                                        <!--begin::Col-->
                                        <div class="col-md-4 fv-row">
                                            <label class="fw-bolder fs-6 fw-bold mb-2 required">مجموع سایر مالیات، عوارض و وجوه قانونی</label>
                                            <input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " placeholder="0" name="todam" value="{{number_format($invoice->todam)}}" required readonly id="todam">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-4 fv-row">
                                            <label class="fw-bolder fs-6 fw-bold mb-2 required">مجموع صورتحساب</label>
                                            <input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " placeholder="0" name="tbill" value="{{number_format($invoice->tbill)}}" required readonly id="tbill">
                                        </div>

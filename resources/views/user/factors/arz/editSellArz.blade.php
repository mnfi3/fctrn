...
@section('title', 'ویرایش فاکتور-فروش ارزی')
@section('content')
                    ...
                    <form method="POST" action="{{route('invoice.update')}}" id="kt_account_profile_details_form" class="form" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div id="kt_account_moshtari_details">
                                        ...
                                        <div class="card-body border-top p-9">
                                            ...
                                            <div class="row g-9">
                                                <div class="col-md-12 fv-row">
                                                    <label class="fw-bolder required fs-6 fw-bold mb-2">خریدار را انتخاب کنید</label>
                        ...
                        <div class="card">
                            ...
                            <div class="card-header border-0">
                                <!--begin::Card title-->
                                <div class="card-title m-0">
                                    <h3 class="fw-bolder m-0">اطلاعات صورت حساب</h3>
                                </div>
                                <!--end::Card title-->
                            </div>
                            <!--begin::Card header-->
                            ...
                            <div id="kt_account_settings_profile_details">
                                ...
                                <div class="card-body border-top p-9">
                                    ...
                                    <div class="row g-9 mb-8">
                                        ...
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-3 fv-row d-none" id="crn">
                                        ...
                                        <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3" id="containn">
                                            ...
                                            @foreach($invoice->items as $item)
                                                <tr class='text-center elementz' id='divz_{{$i+1}}'>
                                                    ...
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300" name="D1[{{$i+1}}]" id="D1[{{$i+1}}]" value="{{$item->sstt}}" readonly/></td>
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300" name="D2[{{$i+1}}]" id="D2[{{$i+1}}]" value="{{number_format($item->cfee)}}"  onkeyup="calculateTotal({{$i+1}})"/></td>
                                                    ...
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D4[{{$i+1}}]" id="D4[{{$i+1}}]" value="{{number_format($item->exr)}}" onkeyup="calculateTotal({{$i+1}})" required/></td>
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D5[{{$i+1}}]" id="D5[{{$i+1}}]" value="{{number_format($item->pspd)}}" /></td>
                                                    ...
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D7[{{$i+1}}]" id="D8[{{$i+1}}]" value="{{number_format($item->dis)}}"  onkeyup="calculateTotal({{$i+1}})"/></td>
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D8[{{$i+1}}]" id="D8[{{$i+1}}]" value="{{$item->adis}}" readonly/></td>
                                                    ...
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D10[{{$i+1}}]" id="D10[{{$i+1}}]" value="{{number_format($item->vam)}}" readonly/></td>
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D11[{{$i+1}}]" id="D11[{{$i+1}}]" value="{{number_format($item->odr)}}" readonly/></td>
                                                    ...
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D13[{{$i+1}}]" id="D13[{{$i+1}}]" value="{{number_format($item->odt)}}" readonly/></td>
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D14[{{$i+1}}]" id="D14[{{$i+1}}]" value="{{number_format($item->olr)}}" readonly/></td>
                                                    ...
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D16[{{$i+1}}]" id="D16[{{$i+1}}]" value="{{number_format($item->olt)}}" readonly/></td>
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D17[{{$i+1}}]" id="D17[{{$i+1}}]" value="{{number_format($item->tsstam)}}" readonly/></td>
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D18[{{$i+1}}]" id="D18[{{$i+1}}]" value="{{number_format($item->bsrn)}}" readonly/></td>
                                                    <td><a class="remove" id="remove_{{$i+1}}"><i class="bi bi-trash-fill text-danger fs-4"></i></a></td>
                                                </tr>
                                                @php
                                                    $i = $i+1;

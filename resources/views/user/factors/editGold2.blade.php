                ...
                <div class="row gy-5 g-xl-8">
                        ...
                        function calculateTotal(i) {
                            ...
                            document.querySelectorAll('#contain tbody tr').forEach(row => {
                                ...
                                if (UnitAmountInput && TedadInput) {
                                    ...
                                    if (VatAmount) {
                                        VatAmount.value = Math.ceil(((rowTotal - Discount) * (parseFloat(VatRateG.value.replace(/,/g, ''))/100)) + ((parseFloat(ConstructionWages.value.replace(/,/g, '')) + parseFloat(SellerProfit.value.replace(/,/g, '')) + parseFloat(Brokerage.value.replace(/,/g, '')))*0.1));
                                    }
                                    var VatAmountValue = Math.ceil(((rowTotal - Discount) * (parseFloat(VatRateG.value.replace(/,/g, ''))/100)) + ((parseFloat(ConstructionWages.value.replace(/,/g, '')) + parseFloat(SellerProfit.value.replace(/,/g, '')) + parseFloat(Brokerage.value.replace(/,/g, '')))*0.1));
                                    if (rowTotalInput) {
                    ...
                    <script>
                        ...
                        function CalculateFactor() {
                            ...
                            var VatAmount = document.getElementById("VatAmountG").value =  Math.ceil((((+UnitAmount * +Tedad)- +Discount)*(VatRate/100)) + ((+ConstructionWages + +SellerProfit + +Brokerage)*0.1));

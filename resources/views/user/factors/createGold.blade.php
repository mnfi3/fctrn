                                ...
                                <div class="card-body border-top p-9">
                                    ...
                                    <div class="row g-9">
                                        ...
                                        <div class="col-md-2 fv-row d-none">
                                            ...
                                            <select class="form-select form-select-solid border-1 border border-gray-300" data-control="select2" data-placeholder="الگوی فروش" name="inp" id="inp" required>
                                        ...
                                        <div class="col-md-2 fv-row">
                                            ...
                                            @endphp
                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300" data-jdp data-jdp-min-date="{{toPersianDate($date)}}" data-jdp-max-date="today" placeholder="1401/01/01" name="indatim" required>
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
...
{{--                                <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>--}}
                                ...
                                <div class="card-body border-top p-9">
                                    ...
                                    <div class="row g-9 mb-0">
                                        ...
                                        <div class="col-md-3 fv-row">
                                            ...
                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider" placeholder="0" name="tprdis" required readonly id="tprdisG">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-3 fv-row">
                                            <label class="fw-bolder fs-6 fw-bold mb-2 required">مجموع اجرت ساخت(ریال)</label>
                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider" placeholder="0" name="tConstructionWages" required readonly id="tConstructionWages">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-3 fv-row">
                                            <label class="fw-bolder fs-6 fw-bold mb-2 required">مجموع سود فروشنده(ریال)</label>
                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider" placeholder="0" name="tSellerProfit" required readonly id="tSellerProfit">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-3 fv-row">
                                            <label class="fw-bolder fs-6 fw-bold mb-2 required">مجموع حق العمل(ریال)</label>
                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider" placeholder="0" name="tBrokerage" required readonly id="tBrokerage">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-3 fv-row">
                                            <label class="fw-bolder fs-6 fw-bold mb-2 required">مجموع تخفیفات</label>
                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider"  placeholder="0" name="tdis" required readonly id="tdisG">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-3 fv-row">
                                            <label class="fw-bolder fs-6 fw-bold mb-2 required">مجموع مبلغ پس از کسر تخفیف</label>
                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider" placeholder="0" name="tadis" required readonly id="tadisG">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-3 fv-row">
                                            <label class="fw-bolder fs-6 fw-bold mb-2 required">مجموع مالیات بر ارزش افزوده</label>
                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider" placeholder="0" name="tvam" required readonly id="tvamG">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-3 fv-row">
                                            <label class="fw-bolder fs-6 fw-bold mb-2 required">مجموع صورتحساب</label>
                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider" placeholder="0" name="tbill" required readonly id="tbillG">
                                        </div>
    ...
    <script>
        document.getElementById("tbillG").value = 0;
        document.getElementById("tvamG").value = 0;
        document.getElementById("tdisG").value = 0;
        document.getElementById("tprdisG").value = 0;
        document.getElementById("tadisG").value = 0;
        document.getElementById("tBrokerage").value = 0;
        document.getElementById("tSellerProfit").value = 0;
        document.getElementById("tConstructionWages").value = 0;

                ...
                <!--begin::Basic info-->
                                ...
                                <div class="card-body border-top p-9">
                                    ...
                                    <div class="row g-9 mb-8">
                                        ...
                                        <div class="col-md-2 fv-row">
                                            ...
                                            @endphp
                                            <input type="text" class="form-control form-control-solid  border-1 border border-gray-300" placeholder="1401/01/01" data-jdp name="indatim" value="{{toPersianDate(date('Y-m-d', $invoice->indatim/1000))}}" data-jdp-min-date="{{toPersianDate($date)}}" data-jdp-max-date="today" name="indatim" required>
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                            ...
                            <div id="kt_account_settings_profile_details" class="collapse show">
                                ...
                                <div class="card-body border-top p-9">
                                    ...
                                    <div class="row g-9">
                                        ...
                                        <!--begin::Col-->
                                        <div class="col-md-2 fv-row">
                                            <label class="required fs-6 fw-bold mb-2 fw-bolder">عیار</label>
                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300" placeholder="عیار" name="cui" id="cui">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-2 fv-row">
                                        ...
                                        <div class="col-md-4 fv-row">
                                            ...
                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300" placeholder="مبلغ قبل از تخفیف" name="AmountBeforeDiscount" id="AmountBeforeDiscountG" readonly>
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-2 fv-row">
                                        ...
                                        <div class="col-md-3 fv-row">
                                            ...
                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300" placeholder="مبلغ بعد از تخفیف" name="AmountAfterDiscount" id="AmountAfterDiscountG" readonly>
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-3 fv-row">
                                            <label class="required fs-6 fw-bold mb-2 fw-bolder">نرخ مالیات بر ارزش افزوده(درصد)</label>
                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300" placeholder="نرخ مالیات بر ارزش افزوده" name="VatRate" value="9"  id="VatRateG" readonly>
                                        </div>
                                        <!--end::Col-->
                                ...
                                <script>
                                    $(document).ready(function(){
                                        ...
                                        $(".add").click(function(){
                                            ...
                                            const collection14 = document.getElementById("cui");
                                            ...
                                            $("#div_" + nextindexx).append('<td><a class="remove" id="remove_' + nextindexx + '" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="حذف"><i class="bi bi-trash-fill text-danger fs-4"></i></a></td>' +
                                                '<td><input type="text" class="  form-control form-control-solid border-1 border border-gray-300" name="D0['+nextindexx+']" id="DI0['+nextindexx+']" readonly/></td>' +
                                                '<td><input type="text" class="form-control form-control-solid border-1 border border-gray-300" name="D01['+nextindexx+']" id="DI01['+nextindexx+']"  readonly/></td>' +
                                                '<td><input type="text" class="form-control form-control-solid border-1 border border-gray-300" name="D14['+nextindexx+']" id="DI14['+nextindexx+']"  readonly/></td>' +
                                                '<td><input type="text" class="  form-control form-control-solid border-1 border border-gray-300" name="D1['+nextindexx+']" id="DI1['+nextindexx+']"  readonly/></td>' +
                                                ...
                                                '<td><input type="text" class="  form-control form-control-solid border-1 border border-gray-300" name="D4['+nextindexx+']" id="DI4['+nextindexx+']"  readonly/></td>' +
                                                ...
                                                '<td><input type="text" class="  form-control form-control-solid border-1 border border-gray-300" name="D6['+nextindexx+']" id="DI6['+nextindexx+']"  readonly/></td>' +

                                                '<td><input type="text" class="  form-control form-control-solid border-1 border border-gray-300" name="D7['+nextindexx+']" id="DI7['+nextindexx+']"  readonly/></td>' +
                                                '<td><input type="text" class="  form-control form-control-solid border-1 border border-gray-300" name="D8['+nextindexx+']" id="DI8['+nextindexx+']"  readonly/></td>' +
                                                '<td><input type="text" class="  form-control form-control-solid border-1 border border-gray-300" name="D11['+nextindexx+']" id="DI11['+nextindexx+']"  readonly/></td>' +
                                            ...
                                            document.getElementById('DI14['+nextindexx+']').value = collection14.value;
                                            ...
                                            document.getElementById('cui').value = null;
                                        ...
                                        <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3" id="contain">
                                            ...
                                            @foreach($invoice->items as $item)
                                                <tr class='text-center element' id='div_{{$i+1}}'>
                                                    ...
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300" name="D0[{{$i+1}}]" id="D0[{{$i+1}}]" value="{{$item->sstid}}" readonly/></td>
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300" name="D01[{{$i+1}}]" id="D01[{{$i+1}}]" value="{{$item->sstt}}" readonly/></td>
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300" name="D14[{{$i+1}}]" id="D14[{{$i+1}}]" value="{{$item->cui}}"/></td>
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300" name="D1[{{$i+1}}]" id="D1[{{$i+1}}]" value="{{$item->mu}}" readonly/></td>
                                                    ...
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D4[{{$i+1}}]" id="D4[{{$i+1}}]" value="{{number_format($item->prdis)}}" readonly/></td>

                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D9[{{$i+1}}]" id="D9[{{$i+1}}]" value="{{number_format($item->consfee)}}"  onkeyup="calculateTotal({{$i+1}})"/></td>
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D10[{{$i+1}}]" id="D10[{{$i+1}}]" value="{{number_format($item->spro)}}"  onkeyup="calculateTotal({{$i+1}})"/></td>
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D13[{{$i+1}}]" id="D13[{{$i+1}}]" value="{{number_format($item->bros)}}"  onkeyup="calculateTotal({{$i+1}})"/></td>
                                                    ...
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D6[{{$i+1}}]" id="D6[{{$i+1}}]" value="{{number_format($item->adis)}}" readonly/></td>


                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D7[{{$i+1}}]" id="D7[{{$i+1}}]" value="{{$item->vra}}" readonly/></td>
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D8[{{$i+1}}]" id="D8[{{$i+1}}]" value="{{$item->vam}}" readonly/></td>
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D11[{{$i+1}}]" id="D11[{{$i+1}}]" value="{{number_format($item->tsstam)}}" readonly/></td>
                                                    <td><a class="remove" id="remove_{{$i+1}}"><i class="bi bi-trash-fill text-danger fs-4"></i></a></td>
                                                </tr>
                                                @php
                                                    $i = $i+1;
                                ...
                                <div class="card-body border-top p-9">
                                    ...
                                    <div class="row g-9 mb-0">
                                        ...
                                        <!--<div class="col-xl-12 rounded border-danger border-1 border-dashed px-7 py-2 fw-bolder bg-light-danger">
                                            <div class="col-xl-12">
                                               <span class="mr-6">
                                                        کاربر گرامی! در صورت انتخاب صورتحساب «نوع دوم» امکان ثبت فروش بصورت نقد/نسیه وجود ندارد.
                                               </span>
                                            </div>
                                        </div>-->

                                        <div class="col-md-4 fv-row" id="cap">
                                        ...
                                        <div class="col-md-4 fv-row" id="insp">
                                        ...
                                        <input type="text" class="d-none" placeholder="0" name="todam" required readonly value="0">
                                        <!--end::Col-->
                                    </div>
                                    <!--end::Input group-->
                                </div>
                        ...
                        function calculateTotal(i) {
                            ...
                            document.querySelectorAll('#contain tbody tr').forEach(row => {
                                ...
                                if (UnitAmountInput && TedadInput) {
                                    ...
                                    if (VatAmount) {
                                        VatAmount.value = Math.floor(((rowTotal - Discount) * (parseFloat(VatRateG.value.replace(/,/g, ''))/100)) + ((parseFloat(ConstructionWages.value.replace(/,/g, '')) + parseFloat(SellerProfit.value.replace(/,/g, '')) + parseFloat(Brokerage.value.replace(/,/g, '')))*0.09));
                                    }
                                    var VatAmountValue = Math.floor(((rowTotal - Discount) * (parseFloat(VatRateG.value.replace(/,/g, ''))/100)) + ((parseFloat(ConstructionWages.value.replace(/,/g, '')) + parseFloat(SellerProfit.value.replace(/,/g, '')) + parseFloat(Brokerage.value.replace(/,/g, '')))*0.09));
                                    if (rowTotalInput) {
                                        rowTotalInput.value = rowTotal - Discount + VatAmountValue + parseFloat(ConstructionWages.value.replace(/,/g, '')) + parseFloat(SellerProfit.value.replace(/,/g, '')) + parseFloat(Brokerage.value.replace(/,/g, ''));
                                    }
                                }
                                divider('DI2[' + i + ']');
                                divider('DI3[' + i + ']');
                    ...
                    <script>
                        ...
                        function CalculatePercantage() {
                            ...
                            var AmountBeforeDiscount = document.getElementById("AmountBeforeDiscountG").value = +UnitAmount * +Tedad;
                            var Discount = document.getElementById("DiscountG").value.replace(/,/g, '');

                            document.getElementById("ConstructionWages").value = (+ConstructionWagesP * (+UnitAmount * +Tedad) ) / 100;
                            document.getElementById("SellerProfit").value = (+SellerProfitP * (+UnitAmount * +Tedad) ) / 100;
                            document.getElementById("Brokerage").value = (+BrokerageP * (+UnitAmount * +Tedad) ) / 100;

                            document.getElementById("AmountAfterDiscountG").value = (+UnitAmount * +Tedad) + +ConstructionWages + +SellerProfit + +Brokerage - +Discount;

...
@section('title', 'ویرایش فاکتور-بلیت هواپیما')
@section('content')
                ...
                @endif
                    ...
                    <form method="POST" action="{{route('invoice.update')}}" id="kt_account_profile_details_form" class="form" enctype="multipart/form-data">
                                ...
                                <div class="card-body border-top p-9">
                                    ...
                                    <div class="row g-9 mb-8">
                                        ...
                                        <div class="col-md-2 fv-row d-none">
                                            ...
                                            <input type="text" value="6" name="inp" id="inp">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-2 fv-row">
                                            <label class="required fs-6 fw-bold mb-2 fw-bolder">نوع خریدار</label>
                                            <select
                                                class="form-select form-select-solid border-1 border border-gray-300"
                                                data-control="select2" data-placeholder="موضوع صورتحساب" name="tob"
                                                id="tob" required onchange="TypeFlight()">
                                                <option value=""></option>
                                        ...
                                        <!--begin::Col-->
                                        <div class="col-md-2 fv-row">
                                            <label class=" fs-6 fw-bold mb-2 fw-bolder">نوع پرواز</label>
                                            <select
                                                class="form-select form-select-solid border-1 border border-gray-300"
                                                data-control="select2" data-placeholder="نوع پرواز" name="ft" id="ft"
                                                required onchange="TypeFlight()">
                                                <option value=""></option>
                                        ...
                                        <div class="col-md-3 fv-row">
                                            <label class="fw-bolder required fs-6 fw-bold mb-2">خریدار</label>
                                        ...
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-2 fv-row" id="bid-show">
                                            <label class=" fs-6 fw-bold mb-2 fw-bolder" id="bid-label">شناسه/کد ملی خریدار<i
                                                    class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                                                    title="شناسه/کد ملی مسافر نباید کمتر از 10 کاراکتر باشد"
                                                    data-bs-original-title="شناسه/کد ملی مسافر نباید کمتر از 10 کاراکتر باشد"
                                                    aria-label="شناسه/کد ملی مسافر نباید کمتر از 10 کاراکتر باشد"></i></label>
                                            <input type="text"
                                                   class="  form-control form-control-solid border-1 border border-gray-300"
                                                   placeholder="شناسه/کد ملی مسافر را وارد نمایید." name="bid" id="bid">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-2 fv-row" id="bpn-show">
                                            <label class=" fs-6 fw-bold mb-2 fw-bolder" id="bpn-label">شماره گذرنامه خریدار<i
                                                    class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                                                    title="شماره گذرنامه مسافر شامل 9 کاراکتر که حاوی 8 رقم و با یک کاراکتر لاتین شروع می شود"
                                                    data-bs-original-title="شماره گذرنامه مسافر شامل 9 کاراکتر که حاوی 8 رقم و با یک کاراکتر لاتین شروع می شود"
                                                    aria-label="شماره گذرنامه مسافر شامل 9 کاراکتر که حاوی 8 رقم و با یک کاراکتر لاتین شروع می شود"></i></label>
                                            <input type="text"
                                                   class="  form-control form-control-solid border-1 border border-gray-300"
                                ...
                                <div class="card-body border-top p-9">
                                    ...
                                    <div class="row g-9">
                                        ...
                                        <div class="col-md-4 fv-row">
                                            ...
                                            <input type="text"
                                                   class="  form-control form-control-solid border-1 border border-gray-300"
                                                   placeholder="شرح کالا را وارد نمایید" name="Sharh" id="Sharh">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-2 fv-row d-none">
                                            ...
                                            <input type="text"
                                                   class="  form-control form-control-solid border-1 border border-gray-300"
                                                   placeholder="شرح کالا را وارد نمایید" name="Unit" id="Unit"
                                                   value="1627">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-2 fv-row d-none">
                                            ...
                                            <input type="text"
                                                   class="  form-control form-control-solid border-1 border border-gray-300 number-divider"
                                                   placeholder="تعداد/مقدار" name="Count" id="Tedad" value="1">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-4 fv-row">
                                        ...
                                        <div class="col-md-4 fv-row">
                                            ...
                                            <input type="text"
                                                   class="  form-control form-control-solid border-1 border border-gray-300 number-divider"
                                                   placeholder="میزان ارز" name="cfee" id="cfee"
                                                   onkeyup="CalculateFactor()">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-4 fv-row">
                                            ...
                                            <input type="text"
                                                   class="  form-control form-control-solid border-1 border border-gray-300 number-divider"
                                                   placeholder="نوع ارز" name="cut" id="cut">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-4 fv-row">
                                            <label class="required fs-6 fw-bold mb-2 fw-bolder">نرخ براری ارز با
                                                ریال</label>
                                            <input type="text"
                                                   class="  form-control form-control-solid border-1 border border-gray-300 number-divider"
                                                   placeholder="نرخ براری ارز با ریال" name="exr" id="exr"
                                                   onkeyup="CalculateFactor()">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                    ...
                                    <div class="row g-9 mt-3">
                                        <!--begin::Col-->
                                        <div class="col-md-4 fv-row">
                                            <label class=" fs-6 fw-bold mb-2 fw-bolder">نرخ سایر مالیات و
                                                عوارض(درصد)</label>
                                            <input type="text"
                                                   class="  form-control form-control-solid border-1 border border-gray-300 number-divider"
                                                   placeholder="0" name="odr" id="odr"
                                                   onkeyup="CalculatePercantageETC()">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-4 fv-row">
                                            ...
                                            <input type="text"
                                                   class="  form-control form-control-solid border-1 border border-gray-300 number-divider"
                                                   placeholder="0" name="odam" id="odam" onkeyup="CalculateFactor()">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-4 fv-row">
                                            <label class=" fs-6 fw-bold mb-2 fw-bolder">موضوع سایر مالیات و
                                                عوارض</label>
                                            <input type="text"
                                                   class="form-control form-control-solid border-1 border border-gray-300"
                                                   placeholder="موضوع سایر مالیات و عوارض را وارد کنید" name="odt"
                                                   id="odt">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-4 fv-row">
                                            <label class=" fs-6 fw-bold mb-2 fw-bolder">نرخ سایر وجوه
                                                قانونی(درصد)</label>
                                            <input type="text"
                                                   class="  form-control form-control-solid border-1 border border-gray-300 number-divider"
                                                   placeholder="0" name="olr" id="olr"
                                                   onkeyup="CalculatePercantageETC()">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-4 fv-row">
                                            ...
                                            <input type="text"
                                                   class="  form-control form-control-solid border-1 border border-gray-300 number-divider"
                                                   placeholder="0" name="olam" id="olam" onkeyup="CalculateFactor()">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-4 fv-row">
                                            ...
                                            <input type="text"
                                                   class="form-control form-control-solid border-1 border border-gray-300"
                                                   placeholder="موضوع سایر وجوه قانونی را وارد کنید" name="olt"
                                                   id="olt">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        ...
                                        <!--end::Col-->
                                        <div class="col-md-4 fv-row">
                                            <label class=" fs-6 fw-bold mb-2 fw-bolder">شماره اقتصادی آژانس<i
                                                    class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                                                    title=""
                                                    data-bs-original-title="در صورتیکه عامل فروش بلیط هواپیما، آژانس مسافرتی بوده و لی صورتحساب فروش بلیط توسط شرکتهای هواپیمایی صادر شود در این فیلد شماره اقتصادی آژانس مسافرتی عامل وارد شود."
                                                    aria-label="در صورتیکه عامل فروش بلیط هواپیما، آژانس مسافرتی بوده و لی صورتحساب فروش بلیط توسط شرکتهای هواپیمایی صادر شود در این فیلد شماره اقتصادی آژانس مسافرتی عامل وارد شود."></i></label>
                                            <input type="text"
                                                   class="  form-control form-control-solid border-1 border border-gray-300"
                                                   placeholder="شماره اقتصادی آژانس" name="tinc" id="tinc">
                                        </div>
                                    </div>
                                    <!--end::Input group-->
                                </div>
                                ...
                                <script>
                                    $(document).ready(function () {
                                        ...
                                        $(".addd").click(function () {
                                            ...
                                            const collection2 = document.getElementById("UnitAmount");
                                            const collection3 = document.getElementById("cfee");
                                            const collection4 = document.getElementById("cut");
                                            const collection5 = document.getElementById("exr");
                                            ...
                                            const collection18 = document.getElementById("tinc");
                                            ...
                                            $("#divz_" + nextindexx).append('<td><a class="remove" id="remove_' + nextindexx + '" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="حذف"><i class="bi bi-trash-fill text-danger fs-4"></i></a></td>' +
                                                '<td class="d-none"><input type="text" class="  form-control form-control-solid border-1 border border-gray-300" name="D0[' + nextindexx + ']" id="D0[' + nextindexx + ']" readonly/>' +
                                                ...
                                                '<td><input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider" name="D3[' + nextindexx + ']" id="D3[' + nextindexx + ']" /></td>' +
                                                '<td><input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider" name="D4[' + nextindexx + ']" id="D4[' + nextindexx + ']" readonly/></td>' +
                                                ...
                                                '<td class="d-none"><input type="text" class="  form-control form-control-solid border-1 border border-gray-300" name="D13['+nextindexx+']" id="D13['+nextindexx+']""/></td>' +
                                                ...
                                                '<td class="d-none"><input type="text" class="  form-control form-control-solid border-1 border border-gray-300" name="D16['+nextindexx+']" id="D16['+nextindexx+']"/></td>' +
                                        ...
                                        $('.containn').on('click', '.remove', function () {
                                            ...
                                            for (let ii = 1; ii <= Number(split_idd[1]); ii++) {
                                                document.querySelectorAll('#containn tbody tr').forEach(row => {
                                                    ...
                                                    var FeeTotalInput = row.querySelector('input[name="D2[' + ii + ']"');
                                                    var tOdam = row.querySelector('input[name="D12[' + ii + ']"');
                                                    var tOlam = row.querySelector('input[name="D15[' + ii + ']"');
                                                    ...
                                                    if (FeeTotalInput) {
                                                        ...
                                                        var tprdistotal = UnitAmountTotal;
                                                        tprdis += tprdistotal;
                                                    }
                                                    if (tOdam && tOlam) {
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3" id="containn">
                                            ...
                                            <tr class="fw-bolder text-center">
                                                ...
                                                <th class="min-w-150px">مبلغ واحد</th>
                                                ...
                                                <th class="min-w-150px">شماره اقتصادی آژانس</th>
                                                <th>عملیات</th>
                                            </tr>
                                            </thead>
                                            <!--end::Table head-->
                                            ...
                                            @foreach($invoice->items as $item)
                                                <tr class='text-center elementz' id='divz_{{$i+1}}'>
                                                    ...
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300" name="D2[{{$i+1}}]" id="D2[{{$i+1}}]" value="{{$item->mu}}" onkeyup="calculateTotal({{$i+1}})" required/></td>
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D3[{{$i+1}}]" id="D3[{{$i+1}}]" value="{{$item->cfee}}" /></td>
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D4[{{$i+1}}]" id="D4[{{$i+1}}]" value="{{number_format($item->cut)}}" /></td>
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D5[{{$i+1}}]" id="D5[{{$i+1}}]" value="{{number_format($item->exr)}}" /></td>
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D6[{{$i+1}}]" id="D6[{{$i+1}}]" value="{{number_format($item->prdis)}}" readonly/></td>
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D7[{{$i+1}}]" id="D7[{{$i+1}}]" value="{{number_format($item->dis)}}" onkeyup="calculateTotal({{$i+1}})"/></td>
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D8[{{$i+1}}]" id="D8[{{$i+1}}]" value="{{number_format($item->adis)}}" readonly/></td>
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D9[{{$i+1}}]" id="D9[{{$i+1}}]" value="{{$item->vra}}" readonly/></td>
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D10[{{$i+1}}]" id="D10[{{$i+1}}]" value="{{$item->vam}}" readonly/></td>
                                                    <td class="d-none"><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D11[{{$i+1}}]" id="D11[{{$i+1}}]" value="{{$item->odr}}" readonly/></td>
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D12[{{$i+1}}]" id="D12[{{$i+1}}]" value="{{number_format($item->odam)}}"  onkeyup="calculateTotal({{$i+1}})"/></td>
                                                    <td class="d-none"><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D13[{{$i+1}}]" id="D13[{{$i+1}}]" value="{{$item->odt}}" readonly/></td>
                                                    <td class="d-none"><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D14[{{$i+1}}]" id="D14[{{$i+1}}]" value="{{$item->olr}}" readonly/></td>
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D15[{{$i+1}}]" id="D15[{{$i+1}}]" value="{{number_format($item->olam)}}"  onkeyup="calculateTotal({{$i+1}})"/></td>
                                                    <td class="d-none"><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D16[{{$i+1}}]" id="D16[{{$i+1}}]" value="{{$item->olt}}" readonly/></td>
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D17[{{$i+1}}]" id="D17[{{$i+1}}]" value="{{number_format($item->tsstam)}}"/></td>
                                                    <td><input type="text" class="form-control form-control-solid  border-1 border border-gray-300 " name="D18[{{$i+1}}]" id="D18[{{$i+1}}]" value="{{number_format($item->tinc)}}" readonly/></td>
                                                    <td><a class="remove" id="remove_{{$i+1}}"><i class="bi bi-trash-fill text-danger fs-4"></i></a></td>
                                                </tr>
                                                @php
                                                    $i = $i+1;
                        ...
                        <div class="card" id="PardaxtInfo">
                            ...
                            <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                                 data-bs-target="#kt_PardaxtInfo" aria-expanded="true" aria-controls="kt_PardaxtInfo">
                                <!--begin::Card title-->
                                <div class="card-title m-0">
                                ...
                                <div class="card-body border-top p-9">
                                    ...
                                    <div class="row g-9 mb-0">
                                        ...
                                        <div class="col-md-4 fv-row">
                                            ...
                                            <select
                                                class="form-select form-select-solid border-1 border border-gray-300"
                                                data-control="select2" name="pmt" id="pmt">
                                        ...
                                        <div class="col-md-4 fv-row">
                                            ...
                                            <input type="text"
                                                   class="form-control form-control-solid border-1 border border-gray-300"
                                                   data-jdp placeholder="1401/01/01" name="pdt" id="pdt">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-4 fv-row">
                                            ...
                                            <input type="text"
                                                   class="form-control form-control-solid border-1 border border-gray-300 number-divider"
                                                   placeholder="0" name="pv" id="pv">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-4 fv-row">
                                            <label class="fw-bolder fs-6 fw-bold mb-2">شماره کارت پرداخت کننده
                                                صورتحساب</label>
                                            <input type="text"
                                                   class="form-control form-control-solid border-1 border border-gray-300"
                                                   placeholder="شماره کارت پرداخت کننده را وارد کنید" name="pcn"
                                                   id="pcn">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-4 fv-row">
                                            <label class="fw-bolder fs-6 fw-bold mb-2">شماره ملی/کد فراگیر پرداخت
                                                کننده</label>
                                            <input type="text"
                                                   class="form-control form-control-solid border-1 border border-gray-300"
                                                   placeholder="شماره ملی/کد فراگیر پرداخت کننده را وارد کنید"
                                                   name="pid" id="pid">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-4 fv-row">
                                            ...
                                            <input type="text"
                                                   class="form-control form-control-solid border-1 border border-gray-300"
                                                   placeholder="شماره پذیرنده فروشگاهی وارد کنید" name="acn" id="acn">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-4 fv-row">
                                            ...
                                            <input type="text"
                                                   class="form-control form-control-solid border-1 border border-gray-300"
                                                   placeholder="شماره پایانه را وارد کنید" name="trmn" id="trmn">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-4 fv-row">
                                            ...
                                            <input type="text"
                                                   class="form-control form-control-solid border-1 border border-gray-300"
                                                   placeholder="شماره پیگیری را وارد کنید" name="trn" id="trn">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-4 fv-row">
                                            ...
                                            <input type="text"
                                                   class="form-control form-control-solid border-1 border border-gray-300"
                                                   placeholder="شماره سوئیچ پرداخت را وارد کنید" name="iinn" id="iinn">
                                        </div>
                                        <!--begin::Col-->
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <div class="d-flex justify-content-end px-8 mb-4 mt-4">
                                        <a class="btn btn-primary addPardaxt badge"
                                           id="kt_account_profile_details_submit">افزودن +</a>
                                    </div>
                                    <!--end::Actions-->
                                    <!--begin::tabel-->
                                    <div
                            ...
                            <div class="card-footer d-flex justify-content-end py-6 px-9">
                                ...
                                <a class="btn btn-primary badge" data-bs-toggle="modal"
                                   data-bs-target="#submitFactorGold">ثبت</a>
                            </div>
                            <!--end::Actions-->
                            <!--begin::Modal - New Target-->
                                            ...
                                            <div class="row gy-5 g-xl-8 align-items-start d-flex">
                                                <div
                                                    ...
                                                    <div class="d-flex justify-content-center">
                                                        <button type="submit" class="btn btn-primary m-1">ثبت موقت
                                                        </button>
                                                        <button type="submit" name="is_send" value="1"
                                                                class="btn btn-success m-1">ثبت نهایی و ارسال
                                                        </button>
                                                    </div>
                                                </div>
                    ...
                    <script>
                        function calculateTotal(i) {
                            ...
                            for (let ii = 1; ii <= Number(split_idd[1]); ii++) {
                                document.querySelectorAll('#containn tbody tr').forEach(row => {
                                    var UnitAmountInput = row.querySelector('input[name="D2[' + ii + ']"');
                                    var VatAmountTotalInput = row.querySelector('input[name="D10[' + ii + ']"');
                                    var DiscountTotalInput = row.querySelector('input[name="D7[' + ii + ']"');
                                    var FeeTotalInput = row.querySelector('input[name="D17[' + ii + ']"');
                                    var TOtherVatsTotal = row.querySelector('input[name="D12[' + ii + ']"');
                                    var TOtherTaxsTotal = row.querySelector('input[name="D15[' + ii + ']"');
                                    var VatRate = row.querySelector('input[name="D9[' + i + ']"');
                                    if (UnitAmountInput) {
                                        var UnitAmountTotal = parseFloat(UnitAmountInput.value.replace(/,/g, '')) || 0;
                                        var tprdistotal = UnitAmountTotal;
                                        tprdis += tprdistotal;
                                    }
                                    if (VatAmountTotalInput) {
                                    ...
                                    if (FeeTotalInput) {
                                        var FeeTotal = parseFloat(FeeTotalInput.value.replace(/,/g, '')) || 0;
                                        var rowTotal = FeeTotal;
                                        ntotal += rowTotal;
                                    }
                    ...
                    <script>
                        ...
                        function CalculateFactor() {
                            ...
                            document.getElementById("AmountBeforeDiscount").value = +UnitAmount;
                            var Discount = document.getElementById("Discount").value.replace(/,/g, '');
                            document.getElementById("AmountAfterDiscount").value = +UnitAmount - +Discount;
                            document.getElementById("VatAmount").value = Math.floor((+UnitAmount - +Discount) * (VatRate / 100));
                            var VatAmount = Math.floor((+UnitAmount - +Discount) * (VatRate / 100));
                            var odam = document.getElementById("odam").value.replace(/,/g, '');
                            var olam = document.getElementById("olam").value.replace(/,/g, '');

                            if (odam && UnitAmount != 0) {
                                resultOdr = (+odam / (+UnitAmount - +Discount)) * 100;
                                document.getElementById("odr").value = resultOdr.toFixed(4);
                            }
                            else{
                                document.getElementById("odr").value = 0;
                            }
                            if (olam && UnitAmount != 0) {
                                resultOlr = (+olam / (+UnitAmount - +Discount)) * 100;
                                document.getElementById("olr").value = resultOlr.toFixed(4);
                            }
                            else{
                                document.getElementById("olr").value = 0;
                            }
                            document.getElementById("bill").value = +UnitAmount - +Discount + +VatAmount + +odam + +olam;
                        ...
                        function CalculatePercantageETC() {
                            ...
                            var olam = document.getElementById("olam").value.replace(/,/g, '');
                            if(UnitAmount){
                                odam = document.getElementById("odam").value = Math.floor(((+UnitAmount - +Discount) * (+odr / 100)));
                                olam = document.getElementById("olam").value = Math.floor(((+UnitAmount - +Discount) * (+olr / 100)));
                            }
                    ...
                    <script>
                        ...
                        function TypeFlight() {
                            var flightType = document.getElementById('ft').value;
                            var customerType = document.getElementById('tob').value;
                            if (flightType == '1') {

                                if(customerType == '1' || customerType == '3' || customerType == '2'){
                                    document.getElementById('bid-label').classList.add('required');
                                    document.getElementById('bpn-label').classList.remove('required');
                                }
                                else if(customerType == '4'){
                                    document.getElementById('bid-label').classList.remove('required');
                                    document.getElementById('bpn-label').classList.add('required');
                                }
                            }
                        }
                    </script>

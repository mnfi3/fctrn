...
@section('title', 'ثبت فاکتور-بلیت هواپیما')
@section('content')
                                        ...
                                        <div class="card-body border-top p-9">
                                            ...
                                            <div class="row g-9">
                                                <div class="col-md-12 fv-row">
                                                    <label class="fw-bolder required fs-6 fw-bold mb-2">مؤدی(فروشنده) را
                                                        انتخاب
                                                        کنید</label>
                                                    <select
                                ...
                                <div class="card-body border-top p-9">
                                    ...
                                    <div class="row g-9">
                                        ...
                                        <div class="col-md-3 fv-row">
                                            <label class="fw-bolder fs-6 fw-bold mb-2">خریدار</label>
                                            <select
                                                class="form-select form-select-solid border-1 border border-gray-300"
                                                data-control="select2" data-placeholder=" خریدار را مشخص کنید..."
                                        ...
                                        <div class="col-md-2 fv-row" id="bid-show">
                                            <label class=" fs-6 fw-bold mb-2 fw-bolder" id="bid-label">شناسه/کد ملی
                                                خریدار<i
                                        ...
                                        <div class="col-md-2 fv-row" id="bpn-show">
                                            <label class=" fs-6 fw-bold mb-2 fw-bolder" id="bpn-label">شماره گذرنامه
                                                خریدار<i
                                                    class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                                        ...
                                        <div class="col-md-2 fv-row">
                                            ...
                                            <input type="text"
                                                   class="  form-control form-control-solid border-1 border border-gray-300"
                                                   data-jdp placeholder="1401/01/01" name="indatim" required>
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->

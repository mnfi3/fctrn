                                    ...
                                    <div class="row g-9">
                                        ...
                                        <div class="col-md-3 fv-row">
                                            ...
                                            <select class="form-select form-select-solid border-1 border border-gray-300" data-control="select2" data-placeholder="نوع مشمولیت" name="inty" id="inty" onchange="intyStatement()" required>
                                                <option value="1">نوع اول(همراه با اطلاعات خریدار)</option>
                                                <option value="2">نوع دوم(بدون اطلاعات خریدار)</option>
                                            </select>
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-2 fv-row d-none">
                                            ...
                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider" value="1" name="inp" id="inp">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-3 fv-row">

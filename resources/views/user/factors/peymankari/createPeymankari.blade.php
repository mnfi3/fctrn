...
@section('title', 'ثبت فاکتور پیمانکاری')
@section('content')
                                ...
                                <div class="card-body border-top p-9">
                                    ...
                                    <div class="row g-9">
                                        ...
                                        <div class="col-md-2 fv-row d-none">
                                            ...
                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider" value="4" name="inp" id="inp">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->

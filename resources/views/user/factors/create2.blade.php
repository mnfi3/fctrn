                                ...
                                <div class="card-body border-top p-9">
                                    ...
                                    <div class="row g-9">
                                        ...
                                        <div class="col-md-2 fv-row">
                                            ...
                                            <select class="form-select form-select-solid border-1 border border-gray-300" data-control="select2" data-placeholder="واحد اندازه گیری" name="Unit" id="Unit">
                                        ...
                                        <div class="col-md-4 fv-row">
                                            ...
                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300" placeholder="مبلغ بعد از تخفیف" name="AmountAfterDiscount" id="AmountAfterDiscount" >
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-4 fv-row">
                                ...
                                <div class="card-body border-top p-9">
                                    ...
                                    <div class="row g-9 mb-0">
                                        ...
                                        <div class="col-md-4 fv-row">
                                            ...
                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider" placeholder="0" name="tprdis" required  id="tprdis">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-4 fv-row">
                                            <label class="fw-bolder fs-6 fw-bold mb-2 required">مجموع تخفیفات</label>
                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider"  placeholder="0" name="tdis" required  id="tdis">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-4 fv-row">
                                            <label class="fw-bolder fs-6 fw-bold mb-2 required">مجموع مبلغ پس از کسر تخفیف</label>
                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider" placeholder="0" name="tadis" required  id="tadis">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-4 fv-row">
                                            <label class="fw-bolder fs-6 fw-bold mb-2 required">مجموع مالیات بر ارزش افزوده</label>
                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider" placeholder="0" name="tvam" required  id="tvam">
                                        </div>
                                        <!--begin::Col-->
                                        <div class="col-md-4 fv-row">
                                            <label class="fw-bolder fs-6 fw-bold mb-2 required">مجموع سایر مالیات، عوارض و وجوه قانونی</label>
                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider" placeholder="0" name="todam" required  id="todam">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-4 fv-row">
                                            <label class="fw-bolder fs-6 fw-bold mb-2 required">مجموع صورتحساب</label>
                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider" placeholder="0" name="tbill" required  id="tbill">
                                        </div>
                                        ...
                                        <div class="col-md-4 fv-row">
                                            ...
                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider" placeholder="0" name="cap" >
                                        </div>
                                        ...
                                        <div class="col-md-4 fv-row">
                                            ...
                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300" placeholder="0" name="tax17" >
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <div class="card-body border-top p-9">
                                        ...
                                        <div class="row g-9">
                                            ...
                                            <div class="col-md-3 fv-row">
                                                ...
                                                <input type="text" class="  form-control form-control-solid border-1 border border-gray-300" placeholder="شماره کوتاژ اظهارنامه گمرکی را وارد نمایید." name="cdcn" >
                                            </div>
                                            ...
                                            <div class="col-md-3 fv-row">
                                                ...
                                                <input type="text" class="  form-control form-control-solid border-1 border border-gray-300" placeholder=" شماره اشتراک/ شناسه قبض بهره بردار" name="billid" >
                                            </div>

                                            <div class="col-md-3 fv-row">
                                                <label class=" fs-6 fw-bold mb-2 fw-bolder"> مجموع وزن خالص</label>
                                                <input type="text" class="  form-control form-control-solid border-1 border border-gray-300" placeholder=" مجموع وزن خالص" name="tonw" >
                                            </div>
                                            <div class="col-md-3 fv-row">
                                                <label class=" fs-6 fw-bold mb-2 fw-bolder"> مجموع ارزش ریالی(اقلام موجود در اظهارنامه گمرکی)</label>
                                                <input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider" placeholder="مجموع ارزش ریالی" name="torv">
                                            </div>

                                            <div class="col-md-3 fv-row">
                                                <label class=" fs-6 fw-bold mb-2 fw-bolder"> مجموع ارزش ارزی(اقلام موجود در اظهارنامه گمرکی)</label>
                                                <input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider" placeholder="مجموع ارزش ارزی" name="tocv" >
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
{{--                                        <div class="col-md-4 fv-row">--}}
{{--                                            <label class="fw-bolder fs-6 fw-bold mb-2 required">مجموع مبلغ قبل از کسر تخفیف</label>--}}
{{--                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider" placeholder="0" name="tprdis" required  id="tprdisG">--}}
{{--                                        </div>--}}
{{--                                        <!--end::Col-->--}}
{{--                                        <!--begin::Col-->--}}
{{--                                        <div class="col-md-4 fv-row">--}}
{{--                                            <label class="fw-bolder fs-6 fw-bold mb-2 required">مجموع تخفیفات</label>--}}
{{--                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider"  placeholder="0" name="tdis" required  id="tdisG">--}}
{{--                                        </div>--}}
{{--                                        <!--end::Col-->--}}
{{--                                        <!--begin::Col-->--}}
{{--                                        <div class="col-md-4 fv-row">--}}
{{--                                            <label class="fw-bolder fs-6 fw-bold mb-2 required">مجموع مبلغ پس از کسر تخفیف</label>--}}
{{--                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider" placeholder="0" name="tadis" required  id="tadisG">--}}
{{--                                        </div>--}}
{{--                                        <!--end::Col-->--}}
{{--                                        <!--begin::Col-->--}}
{{--                                        <div class="col-md-4 fv-row">--}}
{{--                                            <label class="fw-bolder fs-6 fw-bold mb-2 required">مجموع اجرت ساخت(ریال)</label>--}}
{{--                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider" placeholder="0" name="tConstructionWages" required  id="tConstructionWages">--}}
{{--                                        </div>--}}
{{--                                        <!--end::Col-->--}}
{{--                                        <!--begin::Col-->--}}
{{--                                        <div class="col-md-4 fv-row">--}}
{{--                                            <label class="fw-bolder fs-6 fw-bold mb-2 required">مجموع سود فروشنده(ریال)</label>--}}
{{--                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider" placeholder="0" name="tSellerProfit" required  id="tSellerProfit">--}}
{{--                                        </div>--}}
{{--                                        <!--end::Col-->--}}
{{--                                        <!--begin::Col-->--}}
{{--                                        <div class="col-md-4 fv-row">--}}
{{--                                            <label class="fw-bolder fs-6 fw-bold mb-2 required">مجموع حق العمل(ریال)</label>--}}
{{--                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider" placeholder="0" name="tBrokerage" required  id="tBrokerage">--}}
{{--                                        </div>--}}
{{--                                        <!--end::Col-->--}}
{{--                                        <!--begin::Col-->--}}
{{--                                        <div class="col-md-6 fv-row">--}}
{{--                                            <label class="fw-bolder fs-6 fw-bold mb-2 required">مجموع مالیات بر ارزش افزوده</label>--}}
{{--                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider" placeholder="0" name="tvam" required  id="tvamG">--}}
{{--                                        </div>--}}
{{--                                        <!--end::Col-->--}}
{{--                                        <!--begin::Col-->--}}
{{--                                        <div class="col-md-6 fv-row">--}}
{{--                                            <label class="fw-bolder fs-6 fw-bold mb-2 required">مجموع صورتحساب</label>--}}
{{--                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider" placeholder="0" name="tbill" required  id="tbillG">--}}
{{--                                        </div>--}}

...
@section('title', 'ثبت فاکتور صادرات')
@section('content')
                                ...
                                <div class="card-body border-top p-9">
                                    ...
                                    <div class="row g-9">
                                        ...
                                        <div class="col-md-2 fv-row d-none">
                                            ...
                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider" value="7" name="inp" id="inp">
                                        </div>
                                        <!--end::Col-->
...
هر کالا/خدمت در اظهارنامه گمرکی است!"></i>
                                ...
                                <div class="card-body border-top p-9">
                                    ...
                                    <div class="row g-9 mb-0">
                                        ...
                                        <div class="col-md-4 fv-row d-none">
                                            ...
                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider" value="0" name="tvam" required readonly id="tvamG">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-3 fv-row">
                                        ...
                                        <div class="col-md-3 fv-row">
                                            ...
                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider" placeholder="0" name="tonw" required readonly id="tonw">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-3 fv-row">
                                            <label class="fw-bolder fs-6 fw-bold mb-2 required">مجموع ارزش ریالی</label>
                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider" placeholder="0" name="torv" required readonly id="torv">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-3 fv-row">
                                            <label class="fw-bolder fs-6 fw-bold mb-2 required">مجموع ارزش ارزی</label>
                                            <input type="text" class="  form-control form-control-solid border-1 border border-gray-300 number-divider" placeholder="0" name="tocv" required readonly id="tocv">
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-3 fv-row">
    ...
    <script>
        ...
        document.getElementById("tonw").value = 0;
        document.getElementById("tocv").value = 0;
        document.getElementById("torv").value = 0;

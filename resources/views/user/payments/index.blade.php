...
@section('title', 'بسته ها و خریدهای انجام شده')
@section('content')
        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">بسته ها و خریدهای انجام شده
                        <!--begin::Separator-->
                        <span class="h-20px border-gray-200 border-start ms-3 mx-2"></span>
                        <!--end::Separator-->
                        <!--begin::Description-->
                        <small class="text-muted fs-7 fw-bold my-1 ms-1">تمام بسته ها و خریدهای انجام شده را در این بخش مشاهده نمایید.</small>
                        <!--end::Description--></h1>
                    <!--end::Title-->
                        ...
                        <div class="notice d-flex bg-light-success rounded border-success border border-dashed p-6">
                            ...
                            <div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
                                ...
                                <div class="mb-3 mb-md-0 fw-bold">
                                    ...
                                    <div class="fs-6 text-gray-700 pe-7">در حال حاضر هیچ بسته و خریده انجام شده ای یافت نشد. در صورت نیاز می‌توانید با کلیک بر روی دکمه «خرید بسته جدید»، بسته مورد نظر خود را خرید نمایید.</div>
                                </div>
                            </div>
...
{{--                                            <th class="min-w-150px">نام مؤدی</th>--}}
                                            <th class="min-w-120px">تاریخ خرید</th>
                                            <th class="min-w-150px">مبلغ (تومان)</th>
...
{{--                                                <td>--}}
{{--                                                    <span class="text-dark fw-bolder fs-6">تست</span>--}}
{{--                                                </td>--}}
                                                <td>
                                                    <span class="text-dark fw-bolder fs-7 badge badge-light">   {{toPersianDateTime($payment->created_at)}}</span>
                                                </td>
                                                <td>
                                                    <span class="text-dark fw-bolder fs-7">{{number_format($payment->amount)}}</span>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <span class="text-dark fw-bolder fs-7 ">{{$payment->receipt}}</span>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
